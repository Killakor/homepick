...
public class HousePagingUtil {
	 ...
	 * */
	public HousePagingUtil(int currentPage, int totalCount, int rowCount, int pageCount, String pageUrl) {
		this(null,null,currentPage,totalCount,rowCount,pageCount,pageUrl,null);
	}
	public HousePagingUtil(int currentPage, int totalCount, int rowCount, int pageCount, String pageUrl, String addKey) {
		this(null,null,currentPage,totalCount,rowCount,pageCount,pageUrl,addKey);
	}
	public HousePagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount, int pageCount,String pageUrl) {
		this(keyfield,keyword,currentPage,totalCount,rowCount,pageCount,pageUrl,null);
	}
	public HousePagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount, int pageCount,String pageUrl,String addKey) {
	...
	//페이지 표시 문자열 표기 얻기 메서드
	public StringBuffer getPagingHtml() {
		return pagingHtml;
	}
	
	//한 페이지에서 보여줄 게시글의 시작 번호 얻기 메서드
	public int getStartCount() {
		return startCount;
	}
	
	//한 페이지에서 보여줄 게시글의 끝 번호 얻기 메서드
