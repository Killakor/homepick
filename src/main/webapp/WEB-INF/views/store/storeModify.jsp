...
<div class = "container-fluid" style = "width:700px; border: 1px solid #d2f1f7; font-family: 'Gowun Dodum', sans-serif; ">
	<h2>상품 등록</h2>
	<form:form id = "productRegister" action = "storeModify.do" modelAttribute = "storeDTO"
		...
		<ul>
			...
			<li>
				...
				<span id = "file_detail">(${storeDTO.thumbnail_filename}) 파일이 등록되어 있습니다.
				...
				<script type = "text/javascript">
					$(function() {
						$('#file_del').click(function() {
							...
							if(choice) {
								$.ajax({
									data : {prod_num : ${storeDTO.prod_num}},
									type : 'post',
									url : 'deleteFile.do',
									dataType : 'json',
									cache : false,
